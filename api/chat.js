...
Based on the user's problem and their yes/no answers so far, write a short, warm "current analysis" (3–5 sentences) summarising what you're piecing together and where things look like they're heading. Speak directly to the user, like a smart friend. Keep it user-centric. No bullets, no headers — just one cheerful little paragraph.`,
...
1) A short summary paragraph (2–3 sentences) of what you've narrowed down. Warm and human.

2) A practical step-by-step solution as a numbered list (3–6 concrete steps they can actually do today). Plain numbered lines like "1. ...", "2. ...". Each step should be something a regular person — not an expert — can do.

Don't add other sections or headings. Stay user-centric. No technical jargon unless the user's problem is technical.`,

 followup: `${TONE}

The user just saw a diagnostic conclusion with a step-by-step plan and is replying to "Does this solve your problem?". Their reply may confirm, deny, or add nuance. Respond in 3–5 sentences:
 - If solved: celebrate briefly and slip in one short tip to keep it that way.
 - If not solved: name 1–2 likely reasons and one concrete next thing to try.
 - If unclear: ask ONE focused follow-up to pin it down.`,

 details: `${TONE}

Explain a single diagnostic question in the context of a user's problem. Write a warm, plain-language explanation of ~200 words (180–220). Cover: what this typically looks like in everyday life, what to look at first, and how to confirm or rule it out. Use 2–3 short paragraphs. No bullets. No jargon unless the problem itself is technical.`,

 insight: `${TONE}

The user is exploring their problem. Given their path so far, the question they're investigating, and their free-text answer, reply in 3–5 sentences:
 1. Acknowledge what's been narrowed down.
...
export default async function handler(req, res) {
 ...
 generationConfig: { maxOutputTokens, temperature: TEMPERATURE },
 }),
 }
 );
